...
- `extra.json` — empty stub (`[]`). Live non-PC rows are in `extra-part1.json` … `extra-part7.json` (POHA, MOA, GCA, GEWCA, CESOWA, LCA, Vandalism, DPA, Moneylenders, Computer Misuse, Road Traffic, Public Order Act, Misuse of Drugs Act, Immigration Act).
...
SSO check on 17 Sep 2026: still no later *Criminal Procedure Code 2010 (Amendment of First Schedule)* Order after S 42/2026. CPC timeline on SSO still shows S 818/2025 (30 Dec 2025), S 42/2026 (30 Jan 2026), then Act 21 of 2025 (17 Aug 2026). Act 5 of 2024 CPC amendments remain procedure / FME / disclosure, not First Schedule rows. Act 21 of 2025 s.24 *does* amend the First Schedule; encoded rows that can be quoted from the current Penal Code / Gazette text are kept. No new First Schedule Order found between 14 Sep 2026 and 17 Sep 2026. Earlier 7 Sep / 14 Sep 2026 checks reached the same conclusion.

Do not confuse other 2026 “Amendment of First Schedule” instruments (e.g. Registration of Criminals Act S 43/2026 and S 259/2026) with CPC First Schedule changes.
...
Spot-check 17 Sep 2026 (CPC First Schedule values in `c0`–`c22`; same as 7 Sep / 14 Sep 2026):
...
`extra` audit 7 Sep 2026 / 14 Sep 2026 / 17 Sep 2026:
...
- New `extra-part7.json` (17 Sep 2026): Immigration Act 1959 ss.5, 6(1), 6(2), 9(5), 15(3)(a), 15(3)(b), 36, 57(1)(a), 57(1)(aa), 57(1)(c), 57(1)(d)(i)/(ii), 57(1)(d)(iii), 57(1)(e), 57A, 57B, 57C. Arrest marked per IA s.51(3) (reasonably believes — no in-view limit). Remaining s.57(1) document / false-information limbs (k)/(ka)/(l) and s.57D uniforms not indexed in this pass.
