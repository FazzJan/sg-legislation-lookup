...
async function init() {
  ...
  try {
    ...
    const extraFiles = ['data/extra.json', 'data/extra-part1.json', 'data/extra-part2.json', 'data/extra-part3.json', 'data/extra-part4.json', 'data/extra-part5.json', 'data/extra-part6.json', 'data/extra-part7.json'];
    const extraRaw = [];
